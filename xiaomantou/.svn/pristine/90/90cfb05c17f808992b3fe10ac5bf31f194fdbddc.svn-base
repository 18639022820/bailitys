  ...
  <div class="layui-body">
    ...
    <div style="padding: 15px;">
		...
		<ul class="htcon">
			...
			<li><a href="{{URL::to('admin/tool/lunboto')}}">轮播图</a></li>
			<li><a href="{{URL::to('adarticle/articlelist')}}">文章列表</a></li>
		...
		<iframe src="{{URL::to('admin/tool/lunboto')}}" style="width:100%" id="iframepage" scrolling="no" onload="iframeLoad()" frameborder="0"></iframe>
    </div>
  </div>
...
<script type="text/javascript" src="{{url('/')}}/js/layui.js"> </script> 
 <script type="text/javascript">
	...
	$('.list').click(function(){
		...
		if(i==0){
			 ifm.src="{{URL::to('admin/tool/lunboto')}}";
		}
		if(i==1){
			ifm.src="{{URL::to('adarticle/articlelist')}}";
		}
		if(i==2){
    ...
    if(i==6){
      ifm.src="{{URL::to('admin/tool/wallet')}}";
    } 
